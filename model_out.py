...
# input_lang.load_state_dict(checkpoint['input_lang_dict'])
# output_lang.load_state_dict(checkpoint['output_lang_dict'])
...
# TODO: all of the words in our language objects become lower case, while input is upper case. thus inputs with upper case do not work. fix possible?
# TODO 2: also it doesn't seem to recognize the '!' character. not sure what to do here lol
...
print("loading encoder from state dict")
encoder1.load_state_dict(checkpoint['encoder_dict'])
print("loading attention decoder from state dict")
attn_decoder1.load_state_dict(checkpoint['decoder_dict'])
